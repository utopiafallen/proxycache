...
4. Builds an ordered backend list — cache backend first, then fallback backends sorted by LRU (least recently used first) when there's no cache hit
